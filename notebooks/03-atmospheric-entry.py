...
ax1.set_xlabel('Entry Flight Path Angle (°)'); ax1.set_ylabel('Peak g-load')
...
ax2.set_xlabel('Entry Flight Path Angle (°)'); ax2.set_ylabel('Peak Heat Rate (kW/m²)')
...
ax1.set_xlabel('Velocity (km/s)'); ax1.set_ylabel('Altitude (km)')
ax1.set_title('Entry Trajectories — Earth'); ax1.invert_xaxis()
ax1.grid(True, alpha=0.3); ax1.legend()
...
ax2.set_xlabel('Velocity (km/s)'); ax2.set_ylabel('g-load')
ax2.set_title('Deceleration Profile — Earth'); ax2.invert_xaxis()
ax2.grid(True, alpha=0.3); ax2.legend()
