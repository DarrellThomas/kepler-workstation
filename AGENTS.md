# Kepler Workstation — CodeWhale Instructions
...
- KSP community is a key audience (millions of orbital mechanics enthusiasts)

## Current Priority

Three.js viewer → GitHub Pages → X post → UE5 stubs → tutorials

See `.claude/plans/master-plan.md` for the full roadmap.
...
- `Applications/MissileSim/` is export-controlled — do not touch

## .gitignore

- `Private/` — working notes, not published
- `Applications/MissileSim/` — export control
